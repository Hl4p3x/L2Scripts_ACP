...
$_STRINGS = array(
	...
	"EDIT" => "Change",
	//login.php
	"AUTHORIZE_TO_CONTINUE" => "Please, login to continue",
	"LOGIN" => "Log in",
	"REMEMBER" => "Remember",
	...
	"ONE_PLAY_EQUALS" => "One game = 5 Euros",
	...
	//next
	"ATTN_CAPS" => "ATTENTION!",
	"ATTN_DESC1" => "After you bought the euros, it will appear automatically in ACP,",
	"ATTN_DESC2" => "If you want to transfer the euros to your game account, in the form of Coin of Luck,",
	"ATTN_DESC3" => "You need to transfer (every 1 euro you will receive 10 Coins of Luck) using the button,",
	"ATTN_DESC4" => "",
	...
	"1USD1COIN" => "1 EURO = 10 Coin of Luck",
	"DISCOUNT" => "Discount:",	
	"SECONDS" => " Seconds",
	"MINUTES" => " Minutes",
	"HOURS" => " Hours",
